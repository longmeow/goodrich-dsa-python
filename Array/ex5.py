...
sử dụng có thể dùng cho tất cả các datatypes và chỉ chạy được trên python do sử dụng một cấu trúc đặc biệt chỉ python
mới có là set - là một container chứa data với 3 tiêu chí: unordered, unchangeable, unindexed, đi kèm với đặc tính 
